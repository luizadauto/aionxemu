...
public class CraftingTask extends AbstractCraftTask {
    ...
    /* (non-Javadoc)
      * @see com.aionemu.gameserver.skill.task.AbstractCraftTask#onFailureFinish()
      */
    ...
    /* (non-Javadoc)
      * @see com.aionemu.gameserver.skill.task.AbstractCraftTask#onSuccessFinish()
      */
    ...
    /* (non-Javadoc)
      * @see com.aionemu.gameserver.skill.task.AbstractCraftTask#sendInteractionUpdate()
      */
    ...
    /* (non-Javadoc)
      * @see com.aionemu.gameserver.skill.task.AbstractInteractionTask#onInteractionAbort()
      */
    ...
    /* (non-Javadoc)
      * @see com.aionemu.gameserver.skill.task.AbstractInteractionTask#onInteractionFinish()
      */
    ...
    /* (non-Javadoc)
      * @see com.aionemu.gameserver.skill.task.AbstractInteractionTask#onInteractionStart()
      */
