...
public class CraftingTask extends AbstractCraftTask
{
    ...
    protected void onComboStart() {
        PacketSendUtility.sendPacket(requestor, new SM_CRAFT_UPDATE(skillId, itemTemplate, 75, 100, 3));
        PacketSendUtility.broadcastPacket(requestor, new SM_CRAFT_ANIMATION(requestor.getObjectId(), responder.getObjectId(), skillId, 5), true);
    }
}
